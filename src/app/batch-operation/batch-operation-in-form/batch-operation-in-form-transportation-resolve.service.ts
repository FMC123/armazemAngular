...
@Injectable()
export class BatchOperationInFormTransportationResolve implements Resolve<BatchOperation> {
  constructor(
  ...
  resolve(route: ActivatedRouteSnapshot): Observable<any> | Promise<any> | any {
    ...
    return this.transportationService.findByBatchOperation(id).then((transportation: Transportation) => {
      if (transportation) {
