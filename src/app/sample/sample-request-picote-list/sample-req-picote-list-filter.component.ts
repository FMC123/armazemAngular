...
@Component({
	selector: 'app-sample-req-picote-list-filter',
	templateUrl: 'sample-req-picote-list-filter.component.html'
})
export class SampleReqPicoteListFilterComponent implements OnInit {
