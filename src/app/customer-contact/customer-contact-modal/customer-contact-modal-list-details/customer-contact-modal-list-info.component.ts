...
@Component({
  selector: 'app-customer-contact-modal-list-info',
  templateUrl: './customer-contact-modal-list-info.component.html'
})
export class CustomerContactModalListInfoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.leftColumn = [
      ...
      ['Enviar Relatorio de Tickt de Peso' , this.customerContact.indSendPackingTicketWeight ? 'SIM' : 'NÃO'],
    ];
